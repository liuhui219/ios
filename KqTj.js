					...
					<View style={styles.loading}>
					    ...
					    return <View key={i} style={{paddingTop:15, justifyContent:'center',alignItems:'center',}}>
						   <View style={{backgroundColor:'#ddd',paddingTop:3,paddingBottom:3,paddingLeft:8,paddingRight:8,borderRadius:3,}}>
							   <Text style={{color:'#fff'}} allowFontScaling={false}>{data.setTime}</Text>
						   </View>
						   <View style={{flexDirection:'row',paddingTop:15,}}>
							  ...
							  <View style={{flex:1,flexDirection:'column',}}>
								   <Text style={{fontSize:14,}} allowFontScaling={false}>{data.userName}</Text>
								   <View style={{backgroundColor:'#fff', borderRadius:3,marginRight:15,marginTop:5,padding:15,}}>
									  <Text style={{fontSize:14,color:'#4385f4'}} allowFontScaling={false}>{data.info}</Text>   
									  <Text style={{flexWrap:'wrap',marginTop:10,fontSize:14,}} allowFontScaling={false}>{data.qd_result}</Text>
								   </View>
							  </View>
						   </View>
						</View>             
					    ...
					    return <View key={i} style={{paddingTop:15, justifyContent:'center',alignItems:'center',}}>
						   ...
						   <View style={{flexDirection:'row',paddingTop:15,}}>
							  ...
							  <View style={{flex:1,flexDirection:'column',}}>
								   <Text style={{fontSize:14,}} allowFontScaling={false}>{data.userName}</Text>
								   <View style={{backgroundColor:'#fff', borderRadius:3,marginRight:15,marginTop:5,padding:15,}}>
									  <Text style={{color:'#4385f4',fontSize:14,}} allowFontScaling={false}>{data.info}</Text>
									  <Text style={{flexWrap:'wrap',marginTop:10,fontSize:14,}} allowFontScaling={false}>{data.qd_result}</Text>
								   </View>
							  </View>
						   </View>
