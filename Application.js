	    ...
	    <View style={{flex:1,flexDirection:'column',height:Dimensions.get('window').height}}>
		 ...
		 <ScrollView style={{flex:1,flexDirection:'column',backgroundColor:'#ececec',}} automaticallyAdjustContentInsets={false}>
				...
				<View style={{flexDirection:'row',flexWrap:'wrap',backgroundColor:'#fff'}}>
				    <TouchableOpacity  onPress={this._Gonggao.bind(this)} style={{alignItems:'center', justifyContent:'center',width:Dimensions.get('window').width/4,height:Dimensions.get('window').width/4,}}>
					...
					<TouchableOpacity  onPress={this._Kaoqin.bind(this)} style={{alignItems:'center', justifyContent:'center',width:Dimensions.get('window').width/4,height:Dimensions.get('window').width/4,}}>
					  <View style={{alignItems:'center', justifyContent:'center',width:Dimensions.get('window').width/4,height:Dimensions.get('window').width/4,borderRightWidth:1,borderBottomWidth:1,borderColor:'#eee',}}>
					...
					<TouchableOpacity  onPress={this._datetime.bind(this)} style={{alignItems:'center', justifyContent:'center',width:Dimensions.get('window').width/4,height:Dimensions.get('window').width/4,}}>
					  <View style={{alignItems:'center', justifyContent:'center',width:Dimensions.get('window').width/4,height:Dimensions.get('window').width/4,borderRightWidth:1,borderBottomWidth:1,borderColor:'#eee',}}>
					...
					<TouchableOpacity  onPress={this._Mattendance.bind(this)}  style={{alignItems:'center', justifyContent:'center',width:Dimensions.get('window').width/4,height:Dimensions.get('window').width/4,}}>
					  <View style={{alignItems:'center', justifyContent:'center',width:Dimensions.get('window').width/4,height:Dimensions.get('window').width/4,borderRightWidth:1,borderBottomWidth:1,borderColor:'#eee',}}>
					...
					<TouchableOpacity  onPress={this._pan.bind(this)} style={{alignItems:'center', justifyContent:'center',width:Dimensions.get('window').width/4,height:Dimensions.get('window').width/4,}}>
					  <View style={{alignItems:'center', justifyContent:'center',width:Dimensions.get('window').width/4,height:Dimensions.get('window').width/4,borderRightWidth:1,borderBottomWidth:1,borderColor:'#eee',}}>
					...
					<TouchableOpacity  onPress={this._scanner.bind(this)}  style={{alignItems:'center', justifyContent:'center',width:Dimensions.get('window').width/4,height:Dimensions.get('window').width/4,}}>
					  <View style={{alignItems:'center', justifyContent:'center',width:Dimensions.get('window').width/4,height:Dimensions.get('window').width/4,borderRightWidth:1,borderBottomWidth:1,borderColor:'#eee',}}>
