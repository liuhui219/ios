			...
			return (
				<View style={{paddingTop:15, justifyContent:'center',alignItems:'center',}}>
				   <View style={{backgroundColor:'#ddd',paddingTop:3,paddingBottom:3,paddingLeft:8,paddingRight:8,borderRadius:3,}}>
					   <Text style={{color:'#fff'}} allowFontScaling={false}>{data.inputtime}</Text>
				   </View>
				   <View style={{flexDirection:'row',paddingTop:15,}}>
					  ...
					  <View style={{flex:1,flexDirection:'column',}}>
						   <Text style={{fontSize:16,}} allowFontScaling={false}>{data.name}</Text>
						   <View style={{backgroundColor:'#fff', borderRadius:3,marginRight:15,marginTop:5,}}>
							 
							  <Text style={{flexWrap:'wrap',marginTop:10,paddingLeft:15, paddingRight:15,fontSize:13,}} allowFontScaling={false}>{data.title}</Text>
							  <TouchableOpacity  activeOpacity={0.8}  onPress={this._ggButton.bind(this,data.id)}   style={{flexDirection:'row',justifyContent:'space-between',borderTopWidth:1,borderColor:'#dcdcdc',paddingTop:10,paddingBottom:10,marginTop:10,alignItems:'center',paddingLeft:15, paddingRight:15,}}>
