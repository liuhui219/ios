...
export default class Welcomest extends Component {
      ...
      <View>
          ...
          <Swiper style={styles.wrapper}
            ...
            <View style={styles.slide}>
              ...
              <TouchableHighlight onPress={this._pressButton.bind(this)} underlayColor="#1a5fd4" style={{borderRadius:5,}}>
                <View style={{borderWidth:1,borderColor:'#ececec',borderRadius:5,paddingTop:10,paddingBottom:10,paddingLeft:70,paddingRight:70, justifyContent:'center',alignItems:'center',backgroundColor:'#4385f4'}}>
                    <Text style={{fontSize:16, color:'#fff'}} allowFontScaling={false}>返回</Text>
                </View>
              </TouchableHighlight>
              </View>
            </View>
