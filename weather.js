		           ...
		           <View style={styles.card}>
						  ...
						  <View style={{flex:1,alignItems:'center',justifyContent:'center'}}>
									<View style={{justifyContent:'center',flexDirection:'row',alignItems:'center'}}>  
												<Text style={{color:'white',fontSize:18}} allowFontScaling={false}>天气详情</Text>
									</View>
						  </View> 
						  <View style={{flex:1,justifyContent:'center'}}>   
					...
					<ScrollView style={{flex:1,flexDirection:'column',backgroundColor:'#fafafa',width:Dimensions.get('window').width,}}>
						 <View style={{flexDirection:'column',paddingTop:10,paddingLeft:10}}>
                             <Text style={{fontSize:16}} allowFontScaling={false}>{this.props.datas.location['name']}</Text>
                             <Text style={{marginTop:5,color:'#333',fontSize:12}} allowFontScaling={false}>{this.props.datas['last_update'].slice(11,16)}更新</Text>
                         </View>
                         <View style={{flexDirection:'column',alignItems:'center',justifyContent:'center',paddingTop:50,paddingBottom:50}}>    
                            ...
                            <View style={{flexDirection:'row',alignItems:'center',justifyContent:'center'}}> 
                                <Text style={{fontSize:26,color:'#777'}} allowFontScaling={false}>{this.props.datas.now['temperature']}° / {this.props.datas.now['text']}</Text>
                                
                            </View> 
                         </View>
                         <View style={{marginLeft:10,marginRight:10,borderRadius:5,}}>
                              <Text style={{paddingLeft:5,paddingTop:10,borderRadius:5,fontSize:16}} allowFontScaling={false}>生活指数</Text>
                              <ScrollView                     
                                     ...
                                     <View style={{flexDirection:'column'}}>
                                           <View style={{flexDirection:'row',justifyContent:'space-between',backgroundColor:'#dedede',paddingBottom:10,paddingTop:10,}}>
                                             ...
                                             <View  style={{flexDirection:'row',justifyContent:'space-between',paddingTop:18,paddingBottom:18,backgroundColor:'#ececec',}}>
                                                    ...
                                                    <View  style={{flex:1,alignItems:'center',width:(Dimensions.get('window').width)/4-5,}}><Text style={{fontSize:13,color:'#666',}} allowFontScaling={false}>{this.state.car}洗车</Text></View>
                                                    <View  style={{flex:1,alignItems:'center',width:(Dimensions.get('window').width)/4-5,}}><Text style={{fontSize:13,color:'#666',}} allowFontScaling={false}>{this.state.dressing}</Text></View>
                                                    <View  style={{flex:1,alignItems:'center',width:(Dimensions.get('window').width)/4-5,}}><Text style={{fontSize:13,color:'#666',}} allowFontScaling={false}>感冒{this.state.flu}</Text></View>
                                                    <View  style={{flex:1,alignItems:'center',width:(Dimensions.get('window').width)/4-5,}}><Text style={{fontSize:13,color:'#666',}} allowFontScaling={false}>{this.state.sport}运动</Text></View>
                                                    <View  style={{flex:1,alignItems:'center',width:(Dimensions.get('window').width)/4-5,}}><Text style={{fontSize:13,color:'#666',}} allowFontScaling={false}>{this.state.travel}出行</Text></View>
                                                    <View  style={{flex:1,alignItems:'center',width:(Dimensions.get('window').width)/4-5,}}><Text style={{fontSize:13,color:'#666',}} allowFontScaling={false}>紫外线{this.state.uv}</Text></View>
                         ...
                         <View style={{flexDirection:'row',marginTop:30,paddingTop:20,borderTopWidth:1,borderColor:'#ccc',marginLeft:10,marginRight:10}}>
                             <View style={{flex:1,flexDirection:'column',alignItems:'center',justifyContent:'center'}}>
                                 <Text style={{fontSize:16}} allowFontScaling={false}>今天</Text>
                                 <View style={{marginTop:10,marginBottom:10}}>
                                    <Image source={this.state.images0} style={{width: 40, height: 40,}} />
                                 </View>
                                 <Text style={{fontSize:16,color:'#666',marginTop:5}} allowFontScaling={false}>{this.state.Datas['text_day']} / {this.state.Datas['text_night']}</Text>
                                 <Text style={{fontSize:16,color:'#666',marginTop:5}} allowFontScaling={false}>{this.state.Datas['low']}° / {this.state.Datas['high']}°</Text>
                             </View>
                             <View style={{flex:1,flexDirection:'column',alignItems:'center',justifyContent:'center',borderLeftWidth:1,borderRightWidth:1,borderColor:'#ccc'}}>
                                 <Text style={{fontSize:16}} allowFontScaling={false}>明天</Text>
                                 <View style={{marginTop:10,marginBottom:10}}>
                                    <Image source={this.state.images1} style={{width: 40, height: 40,}} />
                                 </View>
                                 <Text style={{fontSize:16,color:'#666',marginTop:5}} allowFontScaling={false}>{this.state.two['text_day']}</Text>
                                 <Text style={{fontSize:16,color:'#666',marginTop:5}} allowFontScaling={false}>{this.state.two['low']}° / {this.state.two['high']}°</Text>
                             </View>
                             <View style={{flex:1,flexDirection:'column',alignItems:'center',justifyContent:'center'}}>
                                 <Text style={{fontSize:16}} allowFontScaling={false}>后天</Text>
                                 <View style={{marginTop:10,marginBottom:10}}>
                                    <Image source={this.state.images2} style={{width: 40, height: 40,}} />
                                 </View>
                                 <Text style={{fontSize:16,color:'#666',marginTop:5}} allowFontScaling={false}>{this.state.three['text_day']}</Text>
                                 <Text style={{fontSize:16,color:'#666',marginTop:5}} allowFontScaling={false}>{this.state.three['low']}° / {this.state.three['high']}°</Text>
                             </View>
                         </View>
					</ScrollView>
	            </View>
