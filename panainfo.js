					  ...
					  <View style={{flex:1,justifyContent:'flex-end',alignItems:'center', flexDirection:'row'}}>
						   ...
						   <TouchableOpacity  onPress={this._add.bind(this)} >
							  <View style={{paddingRight:15,}}>
									<Icon name="ios-more" color="#fff"size={32} style={{marginTop:5}} />
							  </View>
							</TouchableOpacity>
					  </View>
	 ...
	 renderMovie(data,sectionID: number, rowID: number) {
		if(this.state.sx){
			...
			<View style={{flexDirection:'row',flexWrap:'nowrap',}}>
			  ...
			  <Swipeable style={{width:Dimensions.get('window').width,flexDirection:'row'}} rightActionActivationDistance={75} onRightButtonsOpenRelease={this.onOpen.bind(this)} onRightButtonsCloseRelease={this.onClose.bind(this)}
			       rightButtons={[
