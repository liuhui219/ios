	   ...
	   <View style={{flex:1,flexDirection:'column',backgroundColor:'#fff'}}>
				...
				{!this.state.loaded ? <View style={{justifyContent: 'center',alignItems: 'center',flex:1,flexDirection:'column',backgroundColor:'#ececec'}}>
					...
					<View style={{flexDirection:'row',height:50,backgroundColor:'#fff',alignItems:'center',justifyContent:'center',borderBottomWidth:1,borderColor:'#dcdcdc',paddingLeft:10,marginTop:15,}}>
					    <Text style={{fontSize:14,color:'#666',}} allowFontScaling={false}>客户</Text>
						<View  style={{flex:1,marginLeft:15,flexDirection:'row',alignItems:'center',paddingRight:10,height:50,}}> 
					...
					<View style={{flexDirection:'row',height:50,backgroundColor:'#fff',alignItems:'center',justifyContent:'center',borderBottomWidth:1,borderColor:'#dcdcdc',paddingLeft:10,}}>
					    <Text style={{fontSize:14,color:'#666',}} allowFontScaling={false}>金额</Text>
						<View  style={{flex:1,marginLeft:15,flexDirection:'row',alignItems:'center',paddingRight:10,height:50,}}> 
					...
					<View style={{flexDirection:'row',height:50,backgroundColor:'#fff',alignItems:'center',justifyContent:'center',borderBottomWidth:1,borderColor:'#dcdcdc',paddingLeft:10,}}>
					    <Text style={{fontSize:14,color:'#666',}} allowFontScaling={false}>抹零金额</Text>
						<View  style={{flex:1,marginLeft:15,flexDirection:'row',alignItems:'center',paddingRight:10,height:50,}}> 
					...
					<View style={{flexDirection:'row',height:50,backgroundColor:'#fff',alignItems:'center',justifyContent:'center',borderBottomWidth:1,borderColor:'#dcdcdc',paddingLeft:10,}}>
					    <Text style={{fontSize:14,color:'#666',}} allowFontScaling={false}>数量</Text>
						<View  style={{flex:1,marginLeft:15,flexDirection:'row',alignItems:'center',paddingRight:10,height:50,}}> 
					...
					<View style={{flexDirection:'row',height:50,backgroundColor:'#fff',alignItems:'center',justifyContent:'center',borderBottomWidth:1,borderColor:'#dcdcdc',paddingLeft:10,}}>
					    <Text style={{fontSize:14,color:'#666',}} allowFontScaling={false}>订单类型</Text>
						<View  style={{flex:1,marginLeft:15,flexDirection:'row',alignItems:'center',paddingRight:10,height:50,}}> 
                    ...
                    {this.state.datas.product.list.length > 0 ?<View style={{paddingTop:10,paddingBottom:10,paddingLeft:10,backgroundColor:'#fff',flexDirection:'row',borderBottomWidth:1,borderColor:'#dcdcdc',marginTop:15,}}><Text style={{fontSize:16,}} allowFontScaling={false}>订单详情</Text><Text style={{fontSize:14,color:'#aaa',marginLeft:5}} allowFontScaling={false}>(左右滑动查看更多)</Text></View> : null}
                    <ScrollView 			          
					...
					{this.state.datas.product.list.length > 0 ? this.state.datas.product.list.map((data,i) =>{ 
						return  <View key={i} style={{flexDirection:'row',justifyContent:'space-between',flex:1,paddingRight:5,paddingLeft:5,paddingTop:18,paddingBottom:18,backgroundColor:'#fff',borderBottomWidth:1,borderColor:'#dcdcdc',}}>
					        <View  style={{flex:1,alignItems:'center',width:(Dimensions.get('window').width)/4,}}><Text style={{fontSize:14,color:'#666',}} allowFontScaling={false}>{data.proName}</Text></View>
					        ...
					        <View  style={{flex:1,alignItems:'center',width:(Dimensions.get('window').width)/4,}}><Text style={{fontSize:14,color:'#666',}} allowFontScaling={false}>{data.price}</Text></View>
					        <View  style={{flex:1,alignItems:'center',width:(Dimensions.get('window').width)/4,}}><Text style={{fontSize:14,color:'#666',}} allowFontScaling={false}>{data.num}/({data.xxnum}{data.unitName}/{data.relation})</Text></View>
					        <View  style={{flex:1,alignItems:'center',width:(Dimensions.get('window').width)/4,}}><Text style={{fontSize:14,color:'#666',}} allowFontScaling={false}>{data.intoStoreNum}</Text></View>
	
					       
					</View>
					}) : null}
                    {this.state.datas.product.zidan_id.length > 0 ?<View style={{paddingTop:10,paddingBottom:10,paddingLeft:10,backgroundColor:'#fff',flexDirection:'row',borderBottomWidth:1,borderColor:'#dcdcdc',marginTop:2}}><Text style={{fontSize:16,}} allowFontScaling={false}>子单</Text></View> : null}
