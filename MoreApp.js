...
onHideUnderlay(i){
    ...
    return (
	   <View style={{flex:1,flexDirection:'column', backgroundColor:'#ededed'}}>
                <View style={styles.card}>
				  ...
				  <View style={{flex:1,alignItems:'center',justifyContent:'center'}}>
							<View style={{justifyContent:'center',flexDirection:'row',alignItems:'center'}}>
										<Text style={{color:'white',fontSize:16}} allowFontScaling={false}>添加应用</Text>
							</View>
				  </View>
				  <View style={{flex:1,justifyContent:'center'}}>
				...
				{!this.state.loaded ? <View style={{justifyContent: 'center',alignItems: 'center',height:Dimensions.get('window').height-65,backgroundColor:'#fff'}}>
				...
				<ScrollView style={{flex:1,flexDirection:'column',backgroundColor:'#fff'}}>
				    {this.state.datas.map((data, i) => {
						return <View key={i} style={{flexDirection:'row',alignItems: 'center', borderBottomWidth:1,borderColor:'#eee',padding:15,justifyContent:'space-between'}}>
				...
				{this.state.statu ? <TouchableOpacity activeOpacity={1}  style={{justifyContent:'flex-start',alignItems:'center',}} onPress={this._shuax.bind(this)} ><View style={{padding:10,justifyContent:'center',alignItems:'center',height:Dimensions.get('window').height-50,width:Dimensions.get('window').width,backgroundColor:'#fff'}}>
				  <Icon name="ios-refresh-outline" color="#ccc"size={70}  />
				  <Text style={{fontSize:14,color:'#ccc',}} allowFontScaling={false}>点击屏幕，重新刷新</Text>
