    ...
    return ( 
	   <View style={{flex:1,flexDirection:'column',}}>
                <View style={styles.card}>
                  <TouchableOpacity onPress={this.props._quxiao.bind(this)} style={{flex:1,}}>
            ...
            style={{ color:'#666',fontSize:14,textAlignVertical:'top',paddingTop:0,height:120,}}
                ...
                <Animated.View style={{flexDirection:'column',height:260,position:'absolute',bottom:this.state.bottom,left:0,width:Dimensions.get('window').width,backgroundColor:'#eee'}}>
                ...
                <Animated.View style={{flexDirection:'column',height:260,position:'absolute',bottom:this.state.bottom1,left:0,width:Dimensions.get('window').width,backgroundColor:'#eee'}}>
                    <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center',height:45,paddingRight:10,paddingLeft:10,backgroundColor:'#fff'}}>
                        <TouchableOpacity activeOpacity={0.8}  onPress={this._cancle.bind(this)}><Text style={{fontSize:16,}}allowFontScaling={false}>取消</Text></TouchableOpacity>
