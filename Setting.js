        ...
        <View style={[styles.fill, { overflow: 'hidden' }]}>
          ...
          >
           ...
           if (supported) {
            ...
            <TouchableHighlight onPress={this._exits.bind(this)} underlayColor="#1a5fd4" style={{marginLeft:10,marginRight:10,marginTop:20, borderWidth:1,borderColor:'#ececec',borderRadius:5,paddingTop:10,paddingBottom:10, justifyContent:'center',alignItems:'center',backgroundColor:'#4385f4'}}>
