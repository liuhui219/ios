	   ...
	   <View style={{flex:1,flexDirection:'column',backgroundColor:'#fff'}}>
				...
				{!this.state.loaded ? <View style={{justifyContent: 'center',alignItems: 'center',flex:1,flexDirection:'column',backgroundColor:'#ececec'}}>
					...
					<View style={{flexDirection:'row',height:50,backgroundColor:'#fff',alignItems:'center',justifyContent:'center',borderBottomWidth:1,borderColor:'#dcdcdc',paddingLeft:10,marginBottom:15,}}>
					    <Text style={{fontSize:14,color:'#666',}} allowFontScaling={false}>标题</Text>
						<View  style={{flex:1,marginLeft:15,flexDirection:'row',alignItems:'center',paddingRight:10,height:50,}}> 
					...
					<View style={{flexDirection:'row',justifyContent:'space-between',backgroundColor:'#fff',paddingBottom:10,paddingTop:10,borderBottomWidth:1,borderColor:'#dcdcdc',paddingLeft:5,paddingRight:5}}>
                        <View style={{flex:1,}}><Text style={{fontSize:14,alignItems:'center'}} allowFontScaling={false}>编号</Text></View>
                        <View style={{flex:1,alignItems:'center'}}><Text style={{fontSize:14,alignItems:'center'}} allowFontScaling={false}>名称</Text></View>      
                        <View style={{flex:1,alignItems:'center'}}><Text style={{fontSize:14,alignItems:'center'}} allowFontScaling={false}>类别</Text></View>
                        <View style={{flex:1,alignItems:'flex-end'}}><Text style={{fontSize:14,alignItems:'center'}} allowFontScaling={false}>价格</Text></View>
					</View>
					{this.state.datas.list.length>0 ? this.state.datas.list.map((data,i) =>{ 
					    ...
					    <View style={{flexDirection:'row',justifyContent:'space-between',flex:1,paddingRight:5,paddingLeft:5,}}>
					        <View  style={{flex:1,}}><Text style={{fontSize:14,color:'#666',}} allowFontScaling={false}>{data.num}</Text></View>
					        <View  style={{flex:1,alignItems:'center'}}><Text style={{fontSize:14,color:'#666',}} allowFontScaling={false}>{data.names}</Text></View>
					        <View  style={{flex:1,alignItems:'center'}}><Text style={{fontSize:14,color:'#666',}} allowFontScaling={false}>{data.cat}</Text></View>
							<View  style={{flex:1,alignItems:'flex-end'}}><Text style={{fontSize:14,color:'#666',}} allowFontScaling={false}>{data.price}</Text></View>
					    </View>    
